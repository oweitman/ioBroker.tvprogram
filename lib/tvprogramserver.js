...
function tvprogramclass(adapter) {
    ...
    this.doStateChange = function(id,state) {
        ...
        idParts.shift();
        idParts.shift();
        if (idParts[0] == 'selectchannel' ) this.doSelectChannel(idParts,state);
        if (idParts[0] == 'config' )        this.doSelectChannel(idParts,state);
    };
    this.doSelectChannel = function(idParts,state) {
        this.log.debug("doSelectChannel");
    ...
    this.getData = function() {
        ...
        this.getState(stateTemplateconfig.name,false,false,function(err,data) {
            this.createObject(stateTemplateconfig,null,null,function(){
                if (!data) data={val:"{}"};
        ...
        this.getState(stateTemplateselch.name,false,false,function(err,data) {
            this.createObject(stateTemplateselch,null,null,function(){
                if (!data) data={val:""};
