...
*/
	...
	this.createDatapointsPath = function(path=null,callback) {
		const pName = new Promise((resolve, reject)=>{
		...
		const pFavorites = new Promise((resolve, reject)=>{
		...
		const pChannelfilter = new Promise((resolve, reject)=>{
		...
		const pShow = new Promise((resolve, reject)=>{
		...
		const pChannel = new Promise((resolve, reject)=>{
		...
		const pCmd = new Promise((resolve, reject)=>{
		...
		const pRecord = new Promise((resolve, reject)=>{
