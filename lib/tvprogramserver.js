...
function tvprogramclass(adapter) {
     ...
     *
     * @param tvs - An array of strings. Each string is the name of a datapoint that should be checked.
     * @return A Promise that resolves with an array of strings. The array contains the names of all datapoints that exist after the function call.
     */
    this.newTVDatapointsAsync = async function (tvs) {
        this.logsilly('newTVDatapointsAsync ');
        return new Promise(resolve => {
            (async () => {
                const promises = [];
    ...
    this.createDatapointsPath = function (path, callback) {
        const pName = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplatename, path, '', () => {
        ...
        const pConfig = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplateconfig, path, '', () => {
        ...
        const pFavorites = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplatefavorites, path, '', () => {
        ...
        const pChannelfilter = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplatechannelfilter, path, '', () => {
        ...
        const pShow = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplateshow, path, '', () => {
        ...
        const pChannel = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplateselch, path, '', () => {
        ...
        const pCmd = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplateselcmd, path, '', () => {
        ...
        const pRecord = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplateselrecord, path, '', () => {
        ...
        const pLogoPath = new Promise(resolve => {
            ...
            this.createObjectNotExist(stateTemplatesellogopath, path, '', () => {
